...
npm run build -w reactjs-todo-journey # if in workspace root

npm run build # if in the reactjs-todo-journey folder
```
...
npm run start:reactjs-todo-journey # only if in root

npm start # if in reactjs-todo-journey folder
```
