 ...
 * @param {string} [props.resumeUrl] - The URL to resume the journey
 * @returns {Array} - An array with index 0 containing journey state and index 1 containing journey methods
 */
