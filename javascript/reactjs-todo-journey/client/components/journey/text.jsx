...
export default function Text({ callback, inputName }) {
  ...
  const isNameCb = callback.getType() === 'NameCallback' || callback.getType() === 'ValidatedCreateUsernameCallback';
  const autocomplete = isNameCb ? callback.getOutputByName('autocompleteValues')?.join(' ') : undefined;
